...
import { COMPANY, getPhoneLink, getEmailLink } from '../config';
import {
  LayoutDashboard,
  Package,
  ShoppingCart,
              ...
              <nav className="flex flex-col p-6 space-y-2">
                ...
                <div className="mt-6 pt-6 border-t border-slate-100 dark:border-slate-800">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      <p className="font-black text-slate-900 dark:text-white text-sm">{COMPANY.fullName}</p>
                      <p className="text-[10px] text-slate-500">საიდ. კოდი: {COMPANY.identificationCode}</p>
                    </div>
                  </div>

                  <div className="space-y-2 text-xs">
                    <a href={getPhoneLink()} className="flex items-center gap-2 text-slate-600 dark:text-slate-400 hover:text-emerald-600 dark:hover:text-emerald-400">
                      <Phone className="h-3.5 w-3.5" />
                      <span>{COMPANY.phoneFormatted}</span>
                    </a>
                    <a href={COMPANY.whatsapp} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-emerald-600 dark:text-emerald-400">
                    ...
                    <a href={getEmailLink()} className="flex items-center gap-2 text-slate-600 dark:text-slate-400 hover:text-emerald-600 dark:hover:text-emerald-400">
