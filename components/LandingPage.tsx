            ...
            <div className="mt-12 pt-8 border-t border-white/10">
              ...
              <div className="flex flex-wrap justify-center gap-6">
                <div className="flex items-center gap-3 bg-white/5 px-6 py-3 rounded-xl">
                  ...
                  <a href={getEmailLink()} className="text-slate-300 hover:text-emerald-400 transition-colors">
                    {COMPANY.email}
                  </a>
                </div>
                <a href={getPhoneLink()} className="flex items-center gap-3 bg-white/5 px-6 py-3 rounded-xl hover:bg-white/10 transition-colors">
                  <svg className="h-5 w-5 text-emerald-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                  <span className="text-slate-300">{COMPANY.phoneFormatted}</span>
                </a>
                <a href={COMPANY.whatsapp} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 bg-emerald-600/20 border border-emerald-500/30 px-6 py-3 rounded-xl hover:bg-emerald-600/30 transition-colors">
              ...
              <p className="text-sm text-slate-500 mt-4">საიდენტიფიკაციო კოდი: {COMPANY.identificationCode}</p>
            </div>
          </div>
        </section>
